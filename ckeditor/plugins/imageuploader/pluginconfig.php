...
$username = "driss"; $password = '99e844855ec9fe3ddf7af2fdabdb08d7';

    $useruploadfolder = "SiteAbdouLocal/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "SiteAbdouLocal/ckeditor/plugins/imageuploader/uploads";
        

    $useruploadfolder = "SiteAbdouLocal/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "SiteAbdouLocal/uploads";
    ...
    $useruploadfolder = "localhost/SiteAbdouLocal/uploads/";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "localhost/SiteAbdouLocal/uploads/";
